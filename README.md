...
> 📽️ **발표자료(슬라이드): https://namojo.github.io/codex-edu/slides/** — 브라우저에서 ←/→로 넘기고, `P` 키로 PDF 인쇄
...
[교육 페이지](https://namojo.github.io/codex-edu/)에는 강사와 함께 손으로 따라가는 실습 2종이 있습니다. 두 실습은 강의 중에 처음부터 끝까지 함께 진행하고, 아래 저장소 모듈은 같은 원리를 스스로 더 깊이 파는 자가학습 심화 자료입니다.

| 실습 | 무엇을 만드나 | 링크 |
|---|---|---|
| ① 제안서 PPT 만들기 | 작업 폴더를 Codex에 맡겨 기준 문서·Plan·검수 루프를 갖춘 재사용 가능한 PPT 제작 업무환경을 만들고 실제 `.pptx`를 생성 | [교육 페이지 #ex1](https://namojo.github.io/codex-edu/#ex1) |
| ② 멀티스레드 뉴스레터 만들기 | 팀장 스레드가 담당자 스레드들을 병렬로 굴려 AI 트렌드 뉴스레터 1회분을 완성 | [교육 페이지 #ex2](https://namojo.github.io/codex-edu/#ex2) |
